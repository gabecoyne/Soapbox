...
Copy vendor/plugins/soapbox/public/soapbox files to /public/soapbox


== Running on Ruby 1.9.2

  - autoloading ruby 1.9.2 from .rvmrc
...
- figure out how to extend models from application - /log/page_extensions.rb - module
...
- wizywig short codes - [snippet:key], [setting:admin_email], [cropper:image_name,width,height]
- caching - memcache
- default error docs
- sending email
...
- image galleries - bulk upload, ordering, captions
- multi file uploader with progress - https://github.com/blueimp/jQuery-File-Upload/wiki/jQuery-File-Upload-for-Rails-3
